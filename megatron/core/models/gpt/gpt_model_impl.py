...
#
# Backwards-compatible GPTModel implementation copied from upstream commit
# 2b85d0a72aa26b36c182ebb6efe3ab476d97d538 so the current repository HEAD can
# keep its local gpt_layer_specs layout while still exposing the runtime model.
